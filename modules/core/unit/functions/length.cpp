...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 core - length test"

//==============================================================================
// Test behavior of nt2::length
//==============================================================================
...
NT2_TEST_CASE ( length_scalar )
{
  using nt2::length;

  NT2_TEST_EQUAL( length(13.37), 1 );
}

NT2_TEST_CASE ( length_extent_0D )
{
  using nt2::length;
  using nt2::extent;

  extent<nt2::_0D> x;
  NT2_TEST_EQUAL( length(x), 2 );
}

NT2_TEST_CASE_TPL ( length_extents, DYN_DIM_LIST )
{
  using nt2::length;
  using nt2::extent;
